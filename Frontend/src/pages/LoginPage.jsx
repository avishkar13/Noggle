...
const LoginPage = () => {
  ...
  return (
    <PageWrapper>
      <div className="min-h-screen bg-[url('/assets/loginbg.jpg')] bg-cover bg-center relative flex items-center justify-center px-4">

        {/* Glass-like Clipped Section */}
        <div className="w-full max-w-6xl h-[80vh] rounded-3xl overflow-hidden backdrop-blur-sm bg-white/10 shadow-2xl flex border border-white/30 ">
          ...
          {/* Left: Login Form */}
          <div className="w-[60%] text-white flex flex-col justify-center px-12 py-10 relative  ">

            <div className="absolute top-6 left-4">
              <img src="./assets/logo.png" alt="Noggle"
                className='h-16 w-36 rounded-full'
              />
            </div>


            <h2 className="text-4xl font-bold font-serif mb-8">Welcome Back!! </h2>

            <form onSubmit={handleLogin} className="flex flex-col gap-6 ">
              <div className="items-start flex flex-col relative ">
                <label className="input validator w-3/4">Email<label />
              ...
              <div className="items-start flex flex-col relative ">
                <label className="input validator w-3/4">Password<label />
                  <svg className="h-[1em] opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g
                      strokeLinejoin="round"
                      strokeLinecap="round"
                    ...
                    >
                      ...
                      ></path>
                      <circle cx="16.5" cy="8" r=".5" fill="currentColor"></circle>
                    </g>
                  </svg>
                  <input
              ...
              <button className="mt-4 bg-white text-purple-700 font-semibold py-2 rounded-md hover:bg-purple-200 hover:text-md hover:scale-105 duration-300 transition-all shadow-md w-1/2"
                type='submit'
